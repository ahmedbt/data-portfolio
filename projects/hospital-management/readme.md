...
- **Bed Turnover Data Not Included** 
  The dataset doesn't include patient metrics such as patient wait time and hospital stay time which are important KPI metrics in healthcare.
